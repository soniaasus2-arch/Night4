-- DAVI HUB Noite 2 (estável, com key DAVI2024)
local key = "DAVI2024"
...
task.spawn(function()
    while true do
        ...
        updateMutant()
        if not currentMutant then continue end
        local mpos = currentMutant:FindFirstChild("HumanoidRootPart") and currentMutant.HumanoidRootPart.Position or currentMutant.Position
